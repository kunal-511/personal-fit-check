...
import { Play, Pause, RotateCcw, Plus, Minus, SkipForward, Check } from "lucide-react"
...
export function RestTimer({
  ...
  // Used to signal completion without calling onComplete inside a state updater
  ...
  // Timer logic — only decrements; no side effects inside the updater
  useEffect(() => {
    if (!isRunning) return
  ...
  // Handle completion after render, safely outside the state updater
  useEffect(() => {
